...
class Formatter {
     ...
     */
    static async formatJSON(result, outputFile) {
     ...
     */
    static async formatHTML(result, outputFile) {
     ...
     */
    static formatText(result, options = {}) {
        // Summary
     ...
     */
    static formatBaselineStatus(baseline) {
        switch (baseline) {
            case 'widely':
                return chalk_1.default.green('Widely Available');
            case 'newly':
                return chalk_1.default.blue('Newly Available');
            case false:
                return chalk_1.default.red('Limited Support');
            default:
