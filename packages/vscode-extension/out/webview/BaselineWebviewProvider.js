...
class BaselineWebviewProvider {
    ...
    showDashboard() {
        ...
        this.panel = vscode.window.createWebviewPanel('baselineBuddyDashboard', 'Baseline Buddy Dashboard', vscode.ViewColumn.One, {
            enableScripts: true,
    ...
    async scanWorkspace() {
        try {
            ...
            const baselineDetector = new core_1.WorkingBaselineDetector();
            const featureAnalyzer = new core_1.WorkingFeatureAnalyzer();
            const results = [];
...
//# sourceMappingURL=BaselineWebviewProvider.js.map