...
exports.AIAutoFixEngine = void 0;
class AIAutoFixEngine {
     ...
     */
    async analyzeAndFix(code, context) {
...
${fix.alternatives.map(alt => `• ${alt}`).join('\n')}
     ...
     */
    detectBaselineIssues(code, context) {
        const issues = [];
        const lines = code.split('\n');
     ...
     * Select the best fix based on context
     */
    selectBestFix(fixes, context) {
        // Sort by confidence and baseline status
        return fixes.sort((a, b) => {
            if (a.baselineStatus === 'widely' && b.baselineStatus !== 'widely')
                return -1;
            if (b.baselineStatus === 'widely' && a.baselineStatus !== 'widely')
                return 1;
     ...
     */
    getAvailableFixes(issue, fileType) {
...
exports.AIAutoFixEngine = AIAutoFixEngine;
exports.default = AIAutoFixEngine;
//# sourceMappingURL=ai-auto-fix-engine.js.map